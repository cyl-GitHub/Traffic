        ...
        <div class="tab-w">
            <ul class="tab-nav clearfix">
                <li class="" data-index="1" ref="ksTypeClick">
                    <a target="iframe2" href="/title/mockTest" class="a1">小车科目一交规</a>
                </li>
                <li class="active" data-index="0" ref="ksTypeClick">
                    <a target="iframe2" href="#" class="a1">小车科目四安全文明驾驶</a>
                </li>
            </ul>

            <div class="tab-content clearfix active">
                <a class="item" target="iframe2" href="/title/carFourthSx">
                    <p class="p1">
                        <i class="icon icon0"></i>顺序练习</p>
                    <p class="p2">按顺序练习做题</p>
                </a>
                <a class="item" target="iframe2" href="/title/carFourthSj"><p class="p1">
                    <i class="icon icon3"></i>随机练习</p>
                    <p class="p2">所有法规一个不漏</p>
                </a>

                <a class="item" target="iframe2" href="/title/carFourthZj">
                    <p class="p1">
                        <i class="icon icon1"></i>章节练习</p>
                    <p class="p2">按照法规章节逐步分类</p>
                </a>

                <a class="item" target="iframe2" href="/title/carFourthNd">
                    <p class="p1">
                        <i class="icon icon8"></i>难点攻克
                    </p>
                    <p class="p2">准确把握考试难点</p>
                </a>

                <a class="item" target="_blank" href="/title/carFourthQz">
                    <p class="p1">
