...
<head>
    ...
    <script src="${requestScope.ContextPath}/js/car/first/qz.js"></script>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col col1">
                        ...
                        <fieldset class="kaosheng">
                            ...
                            <div class="kaosheng-item kemu red1">科目一</div>
                        ...
                        <fieldset class="kaoti">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="user-answer" style="display: none" id="btn1">
                                    ...
                                    <a class="blue2 why" ref="why">为什么</a>
                                </div>
                            </div>
                    ...
                    <div class="col col3">
                        ...
                        <div class="col col3">
                            <div class="datika">
                                <div class="dtcard" id="tCard" style="overflow:scroll; width:280px; height:352px;">
